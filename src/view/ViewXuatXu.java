...
public class ViewXuatXu extends javax.swing.JFrame {
    ...
    private List<XuatXu> list = new ArrayList<>();
    ...
    void showData(List<XuatXu> listt) {
        model.setRowCount(0);
        for (XuatXu xx : listt) {
            model.addRow(new Object[]{xx.getiD_XuatXu(),xx.getQuocGia()});
        }
    }

    void showDetai(int vt) {
       XuatXu xx = list.get(vt);
        lbID.setText(xx.getiD_XuatXu()+ "");
        txtTen.setText(xx.getQuocGia());
    }
    ...
    boolean check() {
        ...
        ArrayList<XuatXu> listsp = (ArrayList<XuatXu>) xxsv.getAll();
        int listSize = listsp.size();
        for (int i = 0; i < listSize; i++) {
            if (listsp.get(i).getQuocGia().equalsIgnoreCase(txtTen.getText())) {
                JOptionPane.showMessageDialog(this, "Kieu dang nay da ton tai!");
                return false;
            }
        }
        return true;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Danh Sách Xuất Xứ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông Tin Xuất Xứ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
    ...
    private void btnSuaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSuaMouseClicked
        ...
        int row = htDanhSach.getSelectedRow();
        if (row == -1) {
            JOptionPane.showMessageDialog(this, "Ban chua chon kieu dang can sua!");
            return;
        }
        int colum = 0;
        if (row >= 0) {
            ...
            if (check()) {
                XuatXu xx = getForm();
                boolean update = xxsv.update(xx, ma);
                if (update == true) {
                    list = xxsv.getAll();
                    showData(list);
