...
public class ViewKieuDang extends javax.swing.JFrame {
    ...
    private List<KieuDang> list = new ArrayList<>();
    ...
    void showData(List<KieuDang> listt) {
        model.setRowCount(0);
        for (KieuDang kd : listt) {
            model.addRow(new Object[]{kd.getiD_KieuDang(), kd.getTenKieuDang()});
        }
    }

    void showDetai(int vt) {
        KieuDang kd = list.get(vt);
        lbID.setText(kd.getiD_KieuDang() + "");
        txtTen.setText(kd.getTenKieuDang());
    }
    ...
    boolean check() {
        ...
        ArrayList<KieuDang> listsp = (ArrayList<KieuDang>) kdsv.getAll();
        int listSize = listsp.size();
        for (int i = 0; i < listSize; i++) {
            if (listsp.get(i).getTenKieuDang().equalsIgnoreCase(txtTen.getText())) {
    ...
    private KieuDang getForm() {
        ...
        kd.setTenKieuDang(txtTen.getText());
        return kd;
    }
    ...
    private void btnSuaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSuaMouseClicked
        ...
        if (row >= 0) {
            ...
            if (check()) {
                KieuDang kd = getForm();
                boolean update = kdsv.update(kd, ma);
                if (update == true) {
                    list = kdsv.getAll();
                    showData(list);
